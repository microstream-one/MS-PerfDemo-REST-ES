...
package com.microstream.bookstore;
...
import com.microstream.bookstore.data.DataMetrics;
...
public final class BookStoreDemo
{
	 ...
	 *
	 * @param initialDataAmount
	 *            the amount of data which should be generated if the database is empty
	 */
