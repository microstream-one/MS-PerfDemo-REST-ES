...
import static com.microstream.bookstore.util.ValidationUtils.requireNonBlank;
import static com.microstream.bookstore.util.ValidationUtils.requireNonEmpty;
...
public interface Book extends Named
{
	...
	public static interface Validation
	{
		 ...
		 *
		 * @param isbn13
		 *            ths ISBN to validate
		 * @return the given ISBN
		 * @throws IllegalArgumentException
		 *             if the given ISBN is invalid
		 * @throws NumberFormatException
		 *             if parts of the ISBN are no numbers
		 */
		 ...
		 * @throws IllegalArgumentException
		 *             if the given title is empty or <code>null</code>
		 */
		 ...
		 *
		 * @param author
		 *            the author to validate
		 * @return the given author
		 * @throws NullPointerException
		 *             if the given author is <code>null</code>
		 */
		 ...
		 *
		 * @param genre
		 *            the genre to validate
		 * @return the given genre
		 * @throws NullPointerException
		 *             if the given genre is <code>null</code>
		 */
		 ...
		 *
		 * @param publisher
		 *            the publisher to validate
		 * @return the given publisher
		 * @throws NullPointerException
		 *             if the given publisher is <code>null</code>
		 */
		 ...
		 * @throws NullPointerException
		 *             if the given language is <code>null</code>
		 */
		 ...
		 * @throws IllegalArgumentException
		 *             if the given price is negative or zero.
		 */
	 ...
	 *
	 * @param isbn13
	 *            a valid ISBN-13, see {@link Validation#validateIsbn13(String)}
	 * @param title
	 *            not empty, see {@link Validation#validateTitle(String)}
	 * @param author
	 *            not <code>null</code>, see {@link Validation#validateAuthor(Author)}
	 * @param genre
	 *            not <code>null</code>, see {@link Validation#validateGenre(Genre)}
	 * @param publisher
	 *            not <code>null</code>, see {@link Validation#validatePublisher(Publisher)}
	 * @param language
	 *            not <code>null</code>, see {@link Validation#validateLanguage(Language)}
	 * @param purchasePrice
	 *            valid price, see {@link Validation#validatePrice(MonetaryAmount)}
	 * @param retailPrice
	 *            valid price, see {@link Validation#validatePrice(MonetaryAmount)}
	 * @return
	 */
